...
merge_concepts = 0
merging_rate = 0.15
domain = ["rgb","shape"]              # "rgb", "lab", "shape", "4df"
...
calc_statistics = 0             # specifies whether or not statistics are calculated after every guessing game
...
direct_instruction = 1          # if 1, direct instruction is used, otherwise language game style
