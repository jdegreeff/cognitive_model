...
calc_all = 1                    # specifies whether or not all values from every replica are stored in stats
n_training_datasets = 2000      # number of training interactions
n_replicas = 300                # number of replica's of the same training simulation
...
query_knowledge = 1             # if > 0, agent queries knowledge with teacher, 1 is after every guessing game, 10 is after every 10 guessing games etc
